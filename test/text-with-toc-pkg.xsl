...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:toc="http://example.org/toc" xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:use-package name="http://example.org/toc" package-version="1.0"/>

    <xsl:mode on-no-match="shallow-skip"/>

    <xsl:template mode="#unnamed" match="text()">
      ...
      -->
        <xsl:document>
            <html>
                ...
                <body>
                    <div class="toc-container" style="font-size:0.8em; background-color:lightgray">
    ...
    <xsl:template mode="#unnamed" match="head">
