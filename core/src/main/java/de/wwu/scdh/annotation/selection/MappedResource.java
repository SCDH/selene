 ...
 *
 * <code>A1</code>, <code>A2</code>: content parts of the preimage
 * and image. E.g., XdmNode for DOMResources.<P/>
 *
 * <code>P1</code>, <code>P2</code>: {@link Point} in preimage and
 * image.<P/>
 *
 * In a {@link de.wwu.scdh.annotation.selection.resource.DOMResource}, the parsed content type Tx and part type
...
public interface MappedResource<T1, T2, A1, A2> extends Resource<T1> {
	...
	/**
	 * For a given part in the image, this returns the corresponding
