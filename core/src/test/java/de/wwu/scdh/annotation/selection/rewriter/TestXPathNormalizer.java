...
public class TestXPathNormalizer {
	...
	private class DummyNormalizer extends XPathNormalizer {
		...
		@Override
		protected String getNormalizedXPath(DOMResource resource, XdmNode node, boolean escaped)
	...
	public void testPathExpressionXPathRootElement() throws SelectorException, SaxonApiException, IOException {
		...
		Pair<XdmNode, Integer> result =
				normalizer.getTextNodeAtPosition(resource, xpath, 0, Mode.DEEP_NODE_STOP_AT_END);
	...
	public void testPathExpressionXPathRootElementChar4() throws SelectorException, SaxonApiException, IOException {
		...
		xpath = "/*";
		Pair<XdmNode, Integer> result =
				normalizer.getTextNodeAtPosition(resource, xpath, 3, Mode.DEEP_NODE_STOP_AT_END);
		// this selects a text node
		assertEquals("TEXT", result.getLeft().getNodeKind().name());
		assertEquals(
				"/Q{http://www.tei-c.org/ns/1.0}TEI[1]/Q{http://www.tei-c.org/ns/1.0}teiHeader[1]/text()[1]",
				getXPath(result.getLeft()));
		assertEquals(0, result.getRight());
	}
	...
	public void testPathExpressionXPathRootElementPos39() throws SelectorException, SaxonApiException, IOException {
		...
		xpath = "/*";
		Pair<XdmNode, Integer> result =
				normalizer.getTextNodeAtPosition(resource, xpath, 39, Mode.DEEP_NODE_STOP_AT_END);
		// this selects a text node
		assertEquals("TEXT", result.getLeft().getNodeKind().name());
		assertEquals(
				"/Q{http://www.tei-c.org/ns/1.0}TEI[1]/Q{http://www.tei-c.org/ns/1.0}teiHeader[1]/Q{http://www.tei-c.org/ns/1.0}fileDesc[1]/Q{http://www.tei-c.org/ns/1.0}titleStmt[1]/Q{http://www.tei-c.org/ns/1.0}title[1]/text()[1]",
				getXPath(result.getLeft()));
	...
	public void testPathExpressionXPathVerse1() throws SelectorException, SaxonApiException, IOException {
		...
		xpath = "id('v2')/text()[2]";
		Pair<XdmNode, Integer> result =
				normalizer.getTextNodeAtPosition(resource, xpath, 6, Mode.DEEP_NODE_STOP_AT_END);
		// this selects a text node
		assertEquals("TEXT", result.getLeft().getNodeKind().name());
		assertEquals(
	...
	public void testPathExpressionXPathVerse1Char10() throws SelectorException, SaxonApiException, IOException {
		...
		xpath = "id('v2')";
		Pair<XdmNode, Integer> result =
				normalizer.getTextNodeAtPosition(resource, xpath, 10, Mode.DEEP_NODE_STOP_AT_END);
		// this selects a text node
		assertEquals("TEXT", result.getLeft().getNodeKind().name());
		assertEquals(
				"/Q{http://www.tei-c.org/ns/1.0}TEI[1]/Q{http://www.tei-c.org/ns/1.0}text[1]/Q{http://www.tei-c.org/ns/1.0}body[1]/Q{http://www.tei-c.org/ns/1.0}lg[1]/Q{http://www.tei-c.org/ns/1.0}l[2]/Q{http://www.tei-c.org/ns/1.0}app[1]/Q{http://www.tei-c.org/ns/1.0}rdg[1]/text()[1]",
				getXPath(result.getLeft()));
	...
	public void testPathExpressionXPathVerse1Char16() throws SelectorException, SaxonApiException, IOException {
		...
		xpath = "id('v2')";
		Pair<XdmNode, Integer> result =
				normalizer.getTextNodeAtPosition(resource, xpath, 16, Mode.DEEP_NODE_STOP_AT_END);
		// this selects a text node
		assertEquals("TEXT", result.getLeft().getNodeKind().name());
		assertEquals(
				"/Q{http://www.tei-c.org/ns/1.0}TEI[1]/Q{http://www.tei-c.org/ns/1.0}text[1]/Q{http://www.tei-c.org/ns/1.0}body[1]/Q{http://www.tei-c.org/ns/1.0}lg[1]/Q{http://www.tei-c.org/ns/1.0}l[2]/text()[2]",
	...
	public void testPathExpressionXPathVerse1Char100Throws() throws SelectorException, SaxonApiException, IOException {
		...
		assertThrows(
				SelectorException.class,
				() -> normalizer.getTextNodeAtPosition(resource, xpath, 100, Mode.DEEP_NODE_STOP_AT_END));
	}
	...
	protected void assertLuminary(XPathNormalizer normalizer, DOMResource resource, String luminary)
			throws SelectorException {
		Pair<XdmNode, Integer> result;
	...
	protected void assertLuminaryPanel(XPathNormalizer normalizer, DOMResource resource, String luminary)
			throws SelectorException {
		Pair<XdmNode, Integer> result;
		...
		assertThrows(
				SelectorException.class,
				() -> normalizer.getTextNodeAtPosition(resource, "/*:r", 12, Mode.FIRST_OF_DEEPEST_NODES));

		assertThrows(
				SelectorException.class,
				() -> normalizer.getTextNodeAtPosition(resource, "/*:r", 12, Mode.LAST_OF_DEEPEST_NODES));
	}
	...
	protected void assertLuminaryPanelWithFirstSecond(XPathNormalizer normalizer, DOMResource resource, String luminary)
			throws SelectorException {
		Pair<XdmNode, Integer> result;
		...
		assertThrows(
				SelectorException.class, () -> normalizer.getTextNodeAtPosition(resource, "/*:r", 12, Mode.SECOND));
	}
	...
	void assertAmbiguityClass2(Mode mode) throws SelectorException, SaxonApiException, IOException {
		...
		Pair<XdmNode, Integer> result2 =
				normalizer.getTextNodeAtPosition(resource, "/*:r[1]/*:t2[1]/text()[1]", 0, mode);
	...
	void testRefEquivInAmbiguityClass2WithModeFirstOfDeepestNodes()
	...
	@Test
	@Disabled // This mode fails the test!
	void testRefEquivForAmbiguityClass2WithModeLastOfDeepestNodes()
			throws SelectorException, SaxonApiException, IOException {
	...
	@Test
	@Disabled // This mode fails the test!
	void testRefEquivForAmbiguityClass2WithModeDeepNodeStopAtEnd()
			throws SelectorException, SaxonApiException, IOException {
	...
	@Test
	@Disabled // This mode fails the test!
	void testRefEquivForAmbiguityClass2WithModeDeepNodeStepOverEnd()
			throws SelectorException, SaxonApiException, IOException {
